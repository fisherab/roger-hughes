...
with open('results.csv','w', newline='') as csvfile:
    ...
    w.writerow(['EBU num', 'Name', 'Last year MPs', 'This year MPs', 'NGS 2 years ago', 'NGS 1 Year ago', 'NGS Now', 'Improvement', '"Fifty"'])
    for fifty in range(45,51): 
